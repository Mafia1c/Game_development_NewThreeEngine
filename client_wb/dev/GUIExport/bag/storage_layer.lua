...
function ui.init(parent, __data__, __update__)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 0, 330, 538, 490, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_1, "Image_bg", 269, 245, "res/public/bg_npc_06.png")
	GUI:setContentSize(Image_bg, 538, 490)
	...
	-- Create Button_page1
	local Button_page1 = GUI:Button_Create(Panel_1, "Button_page1", 535, 395, "res/public/1900000641.png")
	...
	GUI:setContentSize(Button_page1, 35, 90)
	...
	-- Create PageText
	local PageText = GUI:Text_Create(Button_page1, "PageText", 12, 60, 16, "#ffffff", [[一]])
	...
	-- Create Button_page2
	local Button_page2 = GUI:Button_Create(Panel_1, "Button_page2", 535, 314, "res/public/1900000641.png")
	...
	GUI:setContentSize(Button_page2, 35, 90)
	...
	-- Create PageText
	PageText = GUI:Text_Create(Button_page2, "PageText", 12, 60, 16, "#ffffff", [[二]])
	GUI:Text_enableOutline(PageText, "#000000", 2)
	...
	-- Create Button_page3
	local Button_page3 = GUI:Button_Create(Panel_1, "Button_page3", 535, 233, "res/public/1900000641.png")
	...
	GUI:setContentSize(Button_page3, 35, 90)
	...
	-- Create PageText
	PageText = GUI:Text_Create(Button_page3, "PageText", 12, 60, 16, "#ffffff", [[三]])
	GUI:Text_enableOutline(PageText, "#000000", 2)
	...
	-- Create Button_page4
	local Button_page4 = GUI:Button_Create(Panel_1, "Button_page4", 535, 152, "res/public/1900000641.png")
	...
	GUI:setContentSize(Button_page4, 35, 90)
	...
	-- Create PageText
	PageText = GUI:Text_Create(Button_page4, "PageText", 12, 60, 16, "#ffffff", [[四]])
	GUI:Text_enableOutline(PageText, "#000000", 2)
	...
	-- Create Button_page5
	local Button_page5 = GUI:Button_Create(Panel_1, "Button_page5", 535, 71, "res/public/1900000641.png")
	...
	GUI:setContentSize(Button_page5, 35, 90)
	...
	-- Create PageText
	PageText = GUI:Text_Create(Button_page5, "PageText", 12, 60, 16, "#ffffff", [[五]])
	GUI:Text_enableOutline(PageText, "#000000", 2)
	...
	-- Create Button_quick
	local Button_quick = GUI:Button_Create(Panel_1, "Button_quick", 95, 46, "res/public/1900000652.png")
	...
	TAGOBJ["21"] = Button_quick

	-- Create Button_reset
	local Button_reset = GUI:Button_Create(Panel_1, "Button_reset", 416, 45, "res/public/1900000652.png")
	...
	TAGOBJ["22"] = Button_reset

	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 515, 464, "res/public/01.png")
	...
	TAGOBJ["24"] = Button_close

	-- Create TouchSize
	TouchSize = GUI:Layout_Create(Button_close, "TouchSize", 0, 42, 39, 50, false)
	...
	-- Create Panel_items
	local Panel_items = GUI:Layout_Create(Panel_1, "Panel_items", 29, 434, 482, 342, false)
	...
	TAGOBJ["25"] = Panel_items

	-- Create Panel_itemstouch
	local Panel_itemstouch = GUI:Layout_Create(Panel_1, "Panel_itemstouch", 29, 434, 482, 342, false)
