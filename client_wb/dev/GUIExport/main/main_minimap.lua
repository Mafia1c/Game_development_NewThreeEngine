...
function ui.init(parent)
	-- Create Main_Minimap
	local Main_Minimap = GUI:Layout_Create(parent, "Main_Minimap", 0.00, 0.00, 640.00, 160.00, false)
	...
	-- Create Node
	local Node = GUI:Node_Create(Main_Minimap, "Node", 640.00, 160.00)
	...
	-- Create Map
	local Map = GUI:Layout_Create(Node, "Map", -4.00, -34.00, 133.00, 120.00, true)
	...
	-- Create MapNameBG
	local MapNameBG = GUI:Image_Create(Node, "MapNameBG", 0.00, -1.00, "res/private/main/miniMap/1900012100.png")
	...
	-- Create MapName
	local MapName = GUI:Text_Create(Node, "MapName", -70.00, -16.00, 16, "#ffffff", [[-]])
	...
	-- Create MapStatusBG
	local MapStatusBG = GUI:Layout_Create(Node, "MapStatusBG", -3.00, -146.00, 135.00, 17.00, false)
	...
	-- Create MapStatus
	local MapStatus = GUI:Text_Create(Node, "MapStatus", -136.00, -147.00, 14, "#ffffff", [[安全区域]])
	...
	-- Create PlayerPos
	local PlayerPos = GUI:Text_Create(Node, "PlayerPos", -4.00, -147.00, 14, "#ffffff", [[0:0]])
	...
	GUI:setVisible(MapButton, false)

	-- Create MapButtonText
	local MapButtonText = GUI:Text_Create(MapButton, "MapButtonText", 10.00, 14.00, 22, "#f9ebc0", [[地
图]])
	...
	local PKModelButtonText = GUI:Text_Create(PKModelButton, "PKModelButtonText", 10.00, 14.00, 22, "#f9ebc0", [[全
体]])
