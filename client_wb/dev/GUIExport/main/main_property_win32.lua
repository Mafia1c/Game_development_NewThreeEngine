...
function ui.init(parent, __data__, __update__)
	...
	local LoadingBar_hp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_hp", 78, 114, "res/private/main-win32/1900000502.png", 0)
	...
	local LoadingBar_mp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_mp", 134, 114, "res/private/main-win32/1900000503.png", 0)
	...
	-- Create Image_fhp_bg
	local Image_fhp_bg = GUI:Image_Create(Panel_hp, "Image_fhp_bg", 106, 114, "res/private/main-win32/1900000500.png")
	...
	local LoadingBar_fhp = GUI:LoadingBar_Create(Panel_hp, "LoadingBar_fhp", 106, 114, "res/private/main-win32/1900000501.png", 0)
	...
	-- Create Panel_hp_sfx
	local Panel_hp_sfx = GUI:Layout_Create(Panel_hp, "Panel_hp_sfx", 58, 67, 44, 94, true)
	...
	-- Create Panel_mp_sfx
	local Panel_mp_sfx = GUI:Layout_Create(Panel_hp, "Panel_mp_sfx", 104, 68, 44, 94, true)
	...
	local Panel_fhp_sfx = GUI:Layout_Create(Panel_hp, "Panel_fhp_sfx", 59, 67, 94, 94, true)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_hp, "Image_1", 104, 33, "res/private/main-win32/000009.png")
	GUI:setContentSize(Image_1, 133, 40)
	...
	-- Create Text_hp
	local Text_hp = GUI:BmpText_Create(Image_1, "Text_hp", 65, 28, "#ffffff", [[-]])
	...
	-- Create Text_mp
	local Text_mp = GUI:BmpText_Create(Image_1, "Text_mp", 64, 11, "#ffffff", [[-]])
	...
	local Text_position = GUI:BmpText_Create(Panel_hp, "Text_position", 41, 8, "#ffffff", [[]])
	...
	local Panel_chat_funcs = GUI:Layout_Create(Panel_chat, "Panel_chat_funcs", 2, 152, 200, 15, false)
	...
	local Panel_exit_funcs = GUI:Layout_Create(Panel_chat, "Panel_exit_funcs", 628, 152, 60, 15, false)
	...
	local TextField_input = GUI:TextInput_Create(Panel_chat, "TextField_input", 11, 3, 560, 15, 12)
	...
	-- Create Button_role
	local Button_role = GUI:Button_Create(Panel_act, "Button_role", 32, 153, "res/private/main-win32/00000058.png")
	GUI:Button_loadTexturePressed(Button_role, "res/private/main-win32/00000059.png")
	GUI:Button_setScale9Slice(Button_role, 3, 3, 10, 10)
	...
	-- Create Button_bag
	local Button_bag = GUI:Button_Create(Panel_act, "Button_bag", 76, 162, "res/private/main-win32/00000060.png")
	GUI:Button_loadTexturePressed(Button_bag, "res/private/main-win32/00000061.png")
	GUI:Button_setScale9Slice(Button_bag, 3, 3, 10, 10)
	...
	-- Create Button_skill
	local Button_skill = GUI:Button_Create(Panel_act, "Button_skill", 121, 174, "res/private/main-win32/00000062.png")
	GUI:Button_loadTexturePressed(Button_skill, "res/private/main-win32/00000063.png")
	GUI:Button_setScale9Slice(Button_skill, 3, 3, 10, 10)
	...
	-- Create Button_voice
	local Button_voice = GUI:Button_Create(Panel_act, "Button_voice", 163, 189, "res/private/main-win32/00000064.png")
	GUI:Button_loadTexturePressed(Button_voice, "res/private/main-win32/00000065.png")
	GUI:Button_setScale9Slice(Button_voice, 3, 3, 10, 10)
	...
	GUI:setContentSize(Button_store, 54, 54)
	...
	-- Create Image_time
	local Image_time = GUI:Image_Create(Panel_act, "Image_time", 162, 112, "res/private/main-win32/00000045.png")
	...
	local LoadingBar_exp = GUI:LoadingBar_Create(Panel_act, "LoadingBar_exp", 83, 49, "res/private/main-win32/00000041.png", 0)
	...
	local LoadingBar_weight = GUI:LoadingBar_Create(Panel_act, "LoadingBar_weight", 83, 22, "res/private/main-win32/00000041.png", 0)
	...
	-- Create Text_time
	local Text_time = GUI:BmpText_Create(Panel_act, "Text_time", 57, 98, "#ffffff", [[50]])
	...
	-- Create Text_level
	local Text_level = GUI:BmpText_Create(Panel_act, "Text_level", 63, 76, "#ffffff", [[50]])
	...
	-- Create Text_FPS
	local Text_FPS = GUI:BmpText_Create(Panel_act, "Text_FPS", 113, 76, "#ffffff", [[FPS:60]])
	...
	local Image_laodBarbg = GUI:Image_Create(Panel_act, "Image_laodBarbg", -9, -1, "res/private/main-win32/01072.png")
	...
	-- Create Text_pkmode
	local Text_pkmode = GUI:BmpText_Create(Panel_act, "Text_pkmode", 60, 108, "#ffffff", [==========[[全体攻击模式]]==========])
	...
	local Panel_quick_use_1 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_1", 86, 30, 30, 30, false)
	...
	local Panel_quick_use_2 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_2", 139, 30, 30, 30, false)
	...
	local Panel_quick_use_3 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_3", 192, 30, 30, 30, false)
	...
	local Panel_quick_use_4 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_4", 245, 30, 30, 30, false)
	...
	local Panel_quick_use_5 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_5", 297, 30, 30, 30, false)
	...
	local Panel_quick_use_6 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_6", 351, 30, 30, 30, false)
	...
	local Node_quit_tip = GUI:Node_Create(Panel_mid, "Node_quit_tip", 250, 230)
