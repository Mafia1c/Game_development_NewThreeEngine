...
function ui.init(parent, __data__, __update__)
	...
	-- Create BG
	local BG = GUI:Image_Create(EquipUI, "BG", 174, 239, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/bg_juese_01.png")
	...
	-- Create Panel_pos45
	local Panel_pos45 = GUI:Layout_Create(EquipUI, "Panel_pos45", 170, 210, 85, 140, false)
	...
	-- Create Panel_pos43
	local Panel_pos43 = GUI:Layout_Create(EquipUI, "Panel_pos43", 36, 216, 51, 51, false)
	...
	-- Create Node_43
	local Node_43 = GUI:Node_Create(EquipUI, "Node_43", 36, 216)
	GUI:setChineseName(Node_43, "玩家时装_护身符_位置")
	GUI:setTag(Node_43, 71)
	TAGOBJ["71"] = Node_43

	-- Create Text_shizhuang
	local Text_shizhuang = GUI:Text_Create(EquipUI, "Text_shizhuang", 264, 453, 16, "#ffe400", [[时装外显示]])
	...
	local CheckBox_shizhuang = GUI:CheckBox_Create(EquipUI, "CheckBox_shizhuang", 250, 453, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	-- Create wingLayout
	local wingLayout = GUI:Layout_Create(EquipUI, "wingLayout", 60, 384, 60, 60, false)
