...
function ui.init(parent, __data__, __update__)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 900, 380, 305, 438, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_1, "Image_bg", 152, 219, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015000.png")
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 175, 408, 18, "#ffe400", [[哈哈哈]])
	...
	-- Create ButtonClose
	local ButtonClose = GUI:Button_Create(Panel_1, "ButtonClose", 284, 408, "res/public_win32/01.png")
	GUI:Button_loadTexturePressed(ButtonClose, "res/public_win32/02.png")
	GUI:Button_loadTextureDisabled(ButtonClose, "res/public_win32/02.png")
	...
	-- Create Node_panel
	local Node_panel = GUI:Node_Create(Panel_1, "Node_panel", 7, 16)
	GUI:setChineseName(Node_panel, "玩家面板_节点")
	GUI:setTag(Node_panel, 134)
	TAGOBJ["134"] = Node_panel

	-- Create topLayout
	local topLayout = GUI:Layout_Create(Panel_1, "topLayout", 158, 361, 140, 24, false)
	...
	-- Create base_btn
	local base_btn = GUI:Button_Create(topLayout, "base_btn", -8, 3, "res/private/player_main_layer_ui/player_main_layer_ui_win32/top_btn_2.png")
	...
	GUI:setContentSize(base_btn, 74, 20)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(base_btn, "Text_1", 27, 10, 13, "#807256", [[基础]])
	...
	-- Create ng_btn
	local ng_btn = GUI:Button_Create(topLayout, "ng_btn", 56, 3, "res/private/player_main_layer_ui/player_main_layer_ui_win32/top_btn_2.png")
	...
	GUI:setContentSize(ng_btn, 74, 20)
	...
	-- Create Text_1
	Text_1 = GUI:Text_Create(ng_btn, "Text_1", 27, 10, 13, "#807256", [[内功]])
	GUI:Text_enableOutline(Text_1, "#111111", 2)
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 311, 389, 24, 340, false)
	...
	GUI:Button_loadTexturePressed(Button_101, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_101, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_101, 24, 67)
...
备]])
	...
	-- Create Button_102
	local Button_102 = GUI:Button_Create(Panel_btnList, "Button_102", 0, 283, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_102, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_102, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_102, 24, 67)
	...
	GUI:Button_titleDisableOutLine(Button_102)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_102, "Text_name", 11, 62, 13, "#807256", [[状
态]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	-- Create Button_103
	local Button_103 = GUI:Button_Create(Panel_btnList, "Button_103", 0, 226, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_103, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_103, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_103, 24, 67)
	...
	GUI:Button_titleDisableOutLine(Button_103)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_103, "Text_name", 11, 62, 13, "#807256", [[属
性]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	-- Create Button_104
	local Button_104 = GUI:Button_Create(Panel_btnList, "Button_104", 0, 169, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_104, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_104, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_104, 24, 67)
	...
	GUI:Button_titleDisableOutLine(Button_104)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_104, "Text_name", 11, 62, 13, "#807256", [[技
能]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	-- Create Button_105
	local Button_105 = GUI:Button_Create(Panel_btnList, "Button_105", 0, 112, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	GUI:setContentSize(Button_105, 24, 67)
...
号]])
	...
	-- Create Button_106
	local Button_106 = GUI:Button_Create(Panel_btnList, "Button_106", 0, 55, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	GUI:setContentSize(Button_106, 24, 67)
...
装]])
	...
	local Panel_btnList_ng = GUI:Layout_Create(Panel_1, "Panel_btnList_ng", 304, 358, 24, 340, false)
	...
	TAGOBJ["130"] = Panel_btnList_ng

	-- Create Button_701
	local Button_701 = GUI:Button_Create(Panel_btnList_ng, "Button_701", 0, 340, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_701, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_701, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_701, 24, 67)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_701, "Text_name", 11, 62, 13, "#807256", [[状
态]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	-- Create Button_702
	local Button_702 = GUI:Button_Create(Panel_btnList_ng, "Button_702", 0, 283, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_702, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_702, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_702, 24, 67)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_702, "Text_name", 11, 62, 13, "#807256", [[技
能]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	-- Create Button_703
	local Button_703 = GUI:Button_Create(Panel_btnList_ng, "Button_703", 0, 226, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_703, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_703, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_703, 24, 67)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_703, "Text_name", 11, 62, 13, "#807256", [[经
络]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	-- Create Button_704
	local Button_704 = GUI:Button_Create(Panel_btnList_ng, "Button_704", 0, 169, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_704, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_704, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:setContentSize(Button_704, 24, 67)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_704, "Text_name", 11, 62, 13, "#807256", [[连
击]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	local Panel_btnList_left = GUI:Layout_Create(Panel_1, "Panel_btnList_left", -24, 358, 24, 340, false)
	...
	-- Create Button_112
	local Button_112 = GUI:Button_Create(Panel_btnList_left, "Button_112", 0, 340, "res/public_win32/1900000683_1_f.png")
	GUI:Button_loadTexturePressed(Button_112, "res/public_win32/1900000683_f.png")
	GUI:Button_loadTextureDisabled(Button_112, "res/public_win32/1900000683_f.png")
	GUI:setContentSize(Button_112, 24, 67)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_112, "Text_name", 14, 62, 13, "#807256", [[天
赋]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
