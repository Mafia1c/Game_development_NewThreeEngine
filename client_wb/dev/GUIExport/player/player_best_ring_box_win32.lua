...
function ui.init(parent, __data__, __update__)
	...
	-- Create PMainUI
	local PMainUI = GUI:Layout_Create(parent, "PMainUI", 577, 293, 300, 300, false)
	GUI:setAnchorPoint(PMainUI, 0.50, 0.50)
	GUI:setTouchEnabled(PMainUI, true)
	GUI:setTag(PMainUI, -1)

	-- Create FrameBG
	local FrameBG = GUI:Image_Create(PMainUI, "FrameBG", 0, 0, "res/private/player_best_rings_ui/player_best_rings_ui_win32/bg_sx_01.png")
	GUI:setContentSize(FrameBG, 270, 244)
	...
	-- Create line
	local line = GUI:Image_Create(PMainUI, "line", 138, 194, "res/public/word_sxbt_05.png")
	...
	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 234, 238, "res/public/01.png")
	...
	-- Create PanelItems
	local PanelItems = GUI:Layout_Create(PMainUI, "PanelItems", 13, 20, 246, 182, true)
	...
	-- Create PanelPos31
	local PanelPos31 = GUI:Layout_Create(PanelItems, "PanelPos31", 92, 147, 47, 48, false)
	...
	-- Create PanelPos32
	local PanelPos32 = GUI:Layout_Create(PanelItems, "PanelPos32", 152, 147, 47, 48, false)
	...
	-- Create PanelPos35
	local PanelPos35 = GUI:Layout_Create(PanelItems, "PanelPos35", 93, 90, 47, 48, false)
	...
	-- Create PanelPos36
	local PanelPos36 = GUI:Layout_Create(PanelItems, "PanelPos36", 152, 90, 47, 48, false)
	...
	-- Create PanelPos37
	local PanelPos37 = GUI:Layout_Create(PanelItems, "PanelPos37", 212, 90, 47, 48, false)
	...
	-- Create PanelPos40
	local PanelPos40 = GUI:Layout_Create(PanelItems, "PanelPos40", 152, 34, 47, 48, false)
	...
	-- Create PanelTouch
	local PanelTouch = GUI:Layout_Create(PMainUI, "PanelTouch", 13, 20, 246, 182, true)
