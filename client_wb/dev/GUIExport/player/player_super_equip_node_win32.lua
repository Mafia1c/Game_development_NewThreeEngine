...
function ui.init(parent, __data__, __update__)
	...
	-- Create BG
	local BG = GUI:Image_Create(EquipUI, "BG", 146, 185, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015043_1.png")
	...
	local Node_playerModel = GUI:Node_Create(EquipUI, "Node_playerModel", 150, 155)
	...
	local Panel_posEx17 = GUI:Layout_Create(EquipUI, "Panel_posEx17", 165, 131, 103, 144, false)
	...
	local Panel_posEx18 = GUI:Layout_Create(EquipUI, "Panel_posEx18", 94, 201, 80, 120, false)
	...
	-- Create Panel_pos45
	local Panel_pos45 = GUI:Layout_Create(EquipUI, "Panel_pos45", 144, 174, 124, 216, false)
	...
	-- Create Panel_pos19
	local Panel_pos19 = GUI:Layout_Create(EquipUI, "Panel_pos19", 137, 207, 33, 30, false)
	...
	-- Create Panel_pos21
	local Panel_pos21 = GUI:Layout_Create(EquipUI, "Panel_pos21", 137, 207, 33, 30, false)
	...
	-- Create Panel_pos23
	local Panel_pos23 = GUI:Layout_Create(EquipUI, "Panel_pos23", 28, 139, 42, 42, false)
	...
	-- Create Panel_pos25
	local Panel_pos25 = GUI:Layout_Create(EquipUI, "Panel_pos25", 28, 82, 42, 42, false)
	...
	-- Create Panel_pos24
	local Panel_pos24 = GUI:Layout_Create(EquipUI, "Panel_pos24", 263, 82, 42, 42, false)
	...
	-- Create Panel_pos22
	local Panel_pos22 = GUI:Layout_Create(EquipUI, "Panel_pos22", 263, 139, 42, 42, false)
	...
	-- Create Panel_pos26
	local Panel_pos26 = GUI:Layout_Create(EquipUI, "Panel_pos26", 263, 27, 42, 42, false)
	...
	-- Create Panel_pos20
	local Panel_pos20 = GUI:Layout_Create(EquipUI, "Panel_pos20", 263, 195, 42, 42, false)
	...
	-- Create Panel_pos44
	local Panel_pos44 = GUI:Layout_Create(EquipUI, "Panel_pos44", 28, 27, 42, 42, false)
	...
	-- Create Panel_pos42
	local Panel_pos42 = GUI:Layout_Create(EquipUI, "Panel_pos42", 263, 250, 42, 42, false)
	...
	-- Create Panel_pos29
	local Panel_pos29 = GUI:Layout_Create(EquipUI, "Panel_pos29", 204, 27, 42, 42, false)
	...
	-- Create Panel_pos28
	local Panel_pos28 = GUI:Layout_Create(EquipUI, "Panel_pos28", 146, 27, 42, 42, false)
	...
	-- Create Panel_pos27
	local Panel_pos27 = GUI:Layout_Create(EquipUI, "Panel_pos27", 88, 27, 42, 42, false)
	...
	-- Create Panel_pos43
	local Panel_pos43 = GUI:Layout_Create(EquipUI, "Panel_pos43", 28, 193, 42, 42, false)
	...
	-- Create Node_19
	local Node_19 = GUI:Node_Create(EquipUI, "Node_19", 141, 214)
	GUI:setTag(Node_19, 147)
	TAGOBJ["147"] = Node_19

	-- Create Node_21
	local Node_21 = GUI:Node_Create(EquipUI, "Node_21", 141, 214)
	GUI:setTag(Node_21, 147)
	TAGOBJ["147"] = Node_21

	-- Create Node_23
	local Node_23 = GUI:Node_Create(EquipUI, "Node_23", 28, 139)
	GUI:setChineseName(Node_23, "玩家时装_右手镯_位置")
	GUI:setTag(Node_23, 147)
	TAGOBJ["147"] = Node_23

	-- Create Node_25
	local Node_25 = GUI:Node_Create(EquipUI, "Node_25", 28, 82)
	GUI:setChineseName(Node_25, "玩家时装_右戒指_位置")
	GUI:setTag(Node_25, 151)
	TAGOBJ["151"] = Node_25

	-- Create Node_24
	local Node_24 = GUI:Node_Create(EquipUI, "Node_24", 263, 82)
	GUI:setChineseName(Node_24, "玩家时装_左戒指_位置")
	GUI:setTag(Node_24, 155)
	TAGOBJ["155"] = Node_24

	-- Create Node_22
	local Node_22 = GUI:Node_Create(EquipUI, "Node_22", 263, 139)
	GUI:setChineseName(Node_22, "玩家时装_左手镯_位置")
	GUI:setTag(Node_22, 159)
	TAGOBJ["159"] = Node_22

	-- Create Node_26
	local Node_26 = GUI:Node_Create(EquipUI, "Node_26", 263, 27)
	GUI:setChineseName(Node_26, "玩家时装_勋章_位置")
	GUI:setTag(Node_26, 163)
	TAGOBJ["163"] = Node_26

	-- Create Node_20
	local Node_20 = GUI:Node_Create(EquipUI, "Node_20", 263, 195)
	GUI:setChineseName(Node_20, "玩家时装_项链_位置")
	GUI:setTag(Node_20, 167)
	TAGOBJ["167"] = Node_20

	-- Create Node_44
	local Node_44 = GUI:Node_Create(EquipUI, "Node_44", 28, 27)
	GUI:setChineseName(Node_44, "玩家时装_战鼓_位置")
	GUI:setTag(Node_44, 204)
	TAGOBJ["204"] = Node_44

	-- Create Node_42
	local Node_42 = GUI:Node_Create(EquipUI, "Node_42", 263, 250)
	GUI:setChineseName(Node_42, "玩家时装_坐骑_位置")
	GUI:setTag(Node_42, 208)
	TAGOBJ["208"] = Node_42

	-- Create Node_29
	local Node_29 = GUI:Node_Create(EquipUI, "Node_29", 204, 27)
	GUI:setChineseName(Node_29, "玩家时装_魔血石_位置")
	GUI:setTag(Node_29, 171)
	TAGOBJ["171"] = Node_29

	-- Create Node_28
	local Node_28 = GUI:Node_Create(EquipUI, "Node_28", 146, 27)
	GUI:setChineseName(Node_28, "玩家时装_靴子_位置")
	GUI:setTag(Node_28, 175)
	TAGOBJ["175"] = Node_28

	-- Create Node_27
	local Node_27 = GUI:Node_Create(EquipUI, "Node_27", 88, 27)
	GUI:setChineseName(Node_27, "玩家时装_腰带_位置")
	GUI:setTag(Node_27, 179)
	TAGOBJ["179"] = Node_27

	-- Create Node_43
	local Node_43 = GUI:Node_Create(EquipUI, "Node_43", 28, 193)
	GUI:setChineseName(Node_43, "玩家时装_护身符_位置")
	GUI:setTag(Node_43, 183)
	TAGOBJ["183"] = Node_43

	-- Create Text_shizhuang
	local Text_shizhuang = GUI:Text_Create(EquipUI, "Text_shizhuang", 225, 353, 12, "#ffe400", [[时装外显示]])
	...
	local CheckBox_shizhuang = GUI:CheckBox_Create(EquipUI, "CheckBox_shizhuang", 211, 353, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	-- Create Panel_pos18
	local Panel_pos18 = GUI:Layout_Create(EquipUI, "Panel_pos18", 23, 205, 42, 42, false)
	...
	-- Create Node_18
	local Node_18 = GUI:Node_Create(EquipUI, "Node_18", 23, 205)
	...
	-- Create Panel_pos17
	local Panel_pos17 = GUI:Layout_Create(EquipUI, "Panel_pos17", 23, 160, 42, 42, false)
	...
	-- Create Node_17
	local Node_17 = GUI:Node_Create(EquipUI, "Node_17", 23, 160)
	...
	-- Create wingLayout
	local wingLayout = GUI:Layout_Create(EquipUI, "wingLayout", 26, 320, 50, 50, false)
	GUI:setAnchorPoint(wingLayout, 0.00, 0.00)
	GUI:setTouchEnabled(wingLayout, true)
	GUI:setMouseEnabled(wingLayout, true)
	GUI:setTag(wingLayout, 0)
