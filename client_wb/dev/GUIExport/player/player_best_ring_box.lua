...
function ui.init(parent, __data__, __update__)
	...
	-- Create PMainUI
	local PMainUI = GUI:Layout_Create(parent, "PMainUI", 577, 293, 366, 339, false)
	GUI:setAnchorPoint(PMainUI, 0.50, 0.50)
	GUI:setTouchEnabled(PMainUI, true)
	GUI:setTag(PMainUI, -1)

	-- Create FrameBG
	local FrameBG = GUI:Image_Create(PMainUI, "FrameBG", 0, 0, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/bg_jewelry_1.png")
	GUI:setAnchorPoint(FrameBG, 0.00, 0.00)
	GUI:setTouchEnabled(FrameBG, false)
	GUI:setTag(FrameBG, -1)

	-- Create line
	local line = GUI:Image_Create(PMainUI, "line", 158, 228, "res/public/word_sxbt_05.png")
	GUI:setAnchorPoint(line, 0.50, 0.50)
	GUI:setTouchEnabled(line, false)
	GUI:setTag(line, -1)

	-- Create ImageTitle
	local ImageTitle = GUI:Image_Create(PMainUI, "ImageTitle", 181, 285, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_jewelry_1.png")
	GUI:setAnchorPoint(ImageTitle, 0.50, 0.50)
	GUI:setTouchEnabled(ImageTitle, false)
	GUI:setTag(ImageTitle, -1)
	GUI:setVisible(ImageTitle, false)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 278, 266, "res/public/01.png")
	...
	-- Create PanelItems
	local PanelItems = GUI:Layout_Create(PMainUI, "PanelItems", 13, 14, 292, 219, true)
	GUI:setAnchorPoint(PanelItems, 0.00, 0.00)
	GUI:setTouchEnabled(PanelItems, false)
	GUI:setTag(PanelItems, -1)

	-- Create PanelPos30
	local PanelPos30 = GUI:Layout_Create(PanelItems, "PanelPos30", 40, 180, 52, 52, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(PanelPos30, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_1.png")
	...
	-- Create PanelPos31
	local PanelPos31 = GUI:Layout_Create(PanelItems, "PanelPos31", 111, 180, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos31, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_2.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos32
	local PanelPos32 = GUI:Layout_Create(PanelItems, "PanelPos32", 181, 180, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos32, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_3.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos33
	local PanelPos33 = GUI:Layout_Create(PanelItems, "PanelPos33", 251, 180, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos33, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_4.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos34
	local PanelPos34 = GUI:Layout_Create(PanelItems, "PanelPos34", 41, 110, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos34, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_5.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos35
	local PanelPos35 = GUI:Layout_Create(PanelItems, "PanelPos35", 111, 110, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos35, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_6.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos36
	local PanelPos36 = GUI:Layout_Create(PanelItems, "PanelPos36", 181, 110, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos36, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_7.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos37
	local PanelPos37 = GUI:Layout_Create(PanelItems, "PanelPos37", 251, 110, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos37, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_8.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos38
	local PanelPos38 = GUI:Layout_Create(PanelItems, "PanelPos38", 40, 40, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos38, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_9.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos39
	local PanelPos39 = GUI:Layout_Create(PanelItems, "PanelPos39", 111, 40, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos39, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_10.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos40
	local PanelPos40 = GUI:Layout_Create(PanelItems, "PanelPos40", 180, 40, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos40, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_11.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelPos41
	local PanelPos41 = GUI:Layout_Create(PanelItems, "PanelPos41", 251, 40, 52, 52, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(PanelPos41, "DefaultIcon", 26, 26, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_shengxiao_12.png")
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	GUI:setTag(DefaultIcon, -1)
	...
	-- Create PanelTouch
	local PanelTouch = GUI:Layout_Create(PMainUI, "PanelTouch", 13, 14, 292, 219, true)
