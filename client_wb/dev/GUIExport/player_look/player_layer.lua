...
function ui.init(parent, __data__, __update__)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 900, 340, 380, 544, false)
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 191, 516, 18, "#ffe400", [[]])
	...
	-- Create ButtonClose
	local ButtonClose = GUI:Button_Create(Panel_1, "ButtonClose", 352, 518, "res/public/01.png")
	...
	GUI:Button_setScale9Slice(ButtonClose, 3, 3, 10, 10)
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 377, 470, 32, 454, false)
...
备]])
	...
	-- Create Button_105
	local Button_105 = GUI:Button_Create(Panel_btnList, "Button_105", 0, 382, "res/public/1900000641.png")
...
号]])
	...
	-- Create Button_106
	local Button_106 = GUI:Button_Create(Panel_btnList, "Button_106", 0, 310, "res/public/1900000641.png")
...
装]])
	...
	-- Create Button_112
	local Button_112 = GUI:Button_Create(Panel_btnList, "Button_112", 0, 238, "res/public/1900000641.png")
	GUI:Button_loadTexturePressed(Button_112, "res/public/1900000640.png")
	GUI:Button_loadTextureDisabled(Button_112, "res/public/1900000640.png")
	GUI:setContentSize(Button_112, 35, 90)
	...
	-- Create Text_name
	Text_name = GUI:Text_Create(Button_112, "Text_name", 13, 78, 16, "#807256", [[天
赋]])
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_1, "Image_1", -37, 85, "res/custom/mbtn/mbg4.png")
	GUI:setContentSize(Image_1, 40, 326)
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(Image_1, "Button_1", 6, 227, "res/custom/mbtn/a11.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(Image_1, "Button_2", 6, 168, "res/custom/mbtn/a21.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Button_Create(Image_1, "Button_3", 6, 109, "res/custom/mbtn/a31.png")
	...
	-- Create Button_4
	local Button_4 = GUI:Button_Create(Image_1, "Button_4", 6, 50, "res/custom/mbtn/a41.png")
