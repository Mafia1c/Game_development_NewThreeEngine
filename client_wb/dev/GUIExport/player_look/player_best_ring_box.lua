...
function ui.init(parent, __data__, __update__)
	...
	-- Create line
	local line = GUI:Image_Create(PMainUI, "line", 159, 229, "res/public/word_sxbt_05.png")
	GUI:setAnchorPoint(line, 0.50, 0.50)
	GUI:setTouchEnabled(line, false)
	GUI:setTag(line, -1)

	-- Create ImageTitle
	local ImageTitle = GUI:Image_Create(PMainUI, "ImageTitle", 157, 255, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/word_jewelry_1.png")
	GUI:setAnchorPoint(ImageTitle, 0.50, 0.50)
	GUI:setTouchEnabled(ImageTitle, false)
	GUI:setTag(ImageTitle, -1)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 281, 271, "res/public/01.png")
	...
	-- Create PanelItems
	local PanelItems = GUI:Layout_Create(PMainUI, "PanelItems", 15, 15, 289, 219, true)
	GUI:setAnchorPoint(PanelItems, 0.00, 0.00)
	GUI:setTouchEnabled(PanelItems, false)
	GUI:setTag(PanelItems, -1)

	-- Create PanelPos30
	local PanelPos30 = GUI:Layout_Create(PanelItems, "PanelPos30", 38, 179, 52, 52, false)
	...
	-- Create PanelPos31
	local PanelPos31 = GUI:Layout_Create(PanelItems, "PanelPos31", 109, 179, 52, 52, false)
	...
	-- Create PanelPos32
	local PanelPos32 = GUI:Layout_Create(PanelItems, "PanelPos32", 179, 179, 52, 52, false)
	...
	-- Create PanelPos33
	local PanelPos33 = GUI:Layout_Create(PanelItems, "PanelPos33", 249, 179, 52, 52, false)
	...
	-- Create PanelPos34
	local PanelPos34 = GUI:Layout_Create(PanelItems, "PanelPos34", 38, 109, 52, 52, false)
	...
	-- Create PanelPos35
	local PanelPos35 = GUI:Layout_Create(PanelItems, "PanelPos35", 109, 109, 52, 52, false)
	...
	-- Create PanelPos36
	local PanelPos36 = GUI:Layout_Create(PanelItems, "PanelPos36", 178, 109, 52, 52, false)
	...
	-- Create PanelPos37
	local PanelPos37 = GUI:Layout_Create(PanelItems, "PanelPos37", 248, 109, 52, 52, false)
	...
	-- Create PanelPos38
	local PanelPos38 = GUI:Layout_Create(PanelItems, "PanelPos38", 38, 39, 52, 52, false)
	...
	-- Create PanelPos39
	local PanelPos39 = GUI:Layout_Create(PanelItems, "PanelPos39", 109, 39, 52, 52, false)
	...
	-- Create PanelPos40
	local PanelPos40 = GUI:Layout_Create(PanelItems, "PanelPos40", 178, 39, 52, 52, false)
	...
	-- Create PanelPos41
	local PanelPos41 = GUI:Layout_Create(PanelItems, "PanelPos41", 249, 39, 52, 52, false)
	...
	-- Create PanelTouch
	local PanelTouch = GUI:Layout_Create(PMainUI, "PanelTouch", 15, 15, 289, 219, true)
