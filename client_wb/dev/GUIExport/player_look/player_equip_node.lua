...
function ui.init(parent, __data__, __update__)
	...
	-- Create Panel_pos4
	local Panel_pos4 = GUI:Layout_Create(EquipUI, "Panel_pos4", 36, 282, 50, 50, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(Panel_pos4, "DefaultIcon", 25, 25, "Default/ImageFile.png")
	...
	-- Create Panel_pos13
	local Panel_pos13 = GUI:Layout_Create(EquipUI, "Panel_pos13", 314, 342, 50, 50, false)
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(Panel_pos13, "DefaultIcon", 25, 25, "Default/ImageFile.png")
	...
	-- Create Panel_pos12
	local Panel_pos12 = GUI:Layout_Create(EquipUI, "Panel_pos12", 241, 35, 51, 51, false)
	...
	-- Create Panel_pos10
	local Panel_pos10 = GUI:Layout_Create(EquipUI, "Panel_pos10", 106, 35, 51, 51, false)
	...
	-- Create Panel_pos9
	local Panel_pos9 = GUI:Layout_Create(EquipUI, "Panel_pos9", 36, 219, 51, 51, false)
	...
	-- Create Node_4
	local Node_4 = GUI:Node_Create(EquipUI, "Node_4", 36, 282)
	GUI:setChineseName(Node_4, "玩家装备_头盔_位置")
	GUI:setTag(Node_4, 212)
	TAGOBJ["212"] = Node_4

	-- Create Node_13
	local Node_13 = GUI:Node_Create(EquipUI, "Node_13", 314, 342)
	...
	-- Create Node_12
	local Node_12 = GUI:Node_Create(EquipUI, "Node_12", 241, 35)
	...
	-- Create Node_10
	local Node_10 = GUI:Node_Create(EquipUI, "Node_10", 106, 35)
	GUI:setChineseName(Node_10, "玩家装备_腰带_位置")
	GUI:setTag(Node_10, 68)
	TAGOBJ["68"] = Node_10

	-- Create Node_9
	local Node_9 = GUI:Node_Create(EquipUI, "Node_9", 36, 219)
	...
	-- Create Best_ringBox
	local Best_ringBox = GUI:Layout_Create(EquipUI, "Best_ringBox", 287, 374, 54, 43, false)
	...
	-- Create Panel_pos89
	local Panel_pos89 = GUI:Layout_Create(EquipUI, "Panel_pos89", 36, 345, 51, 51, false)
	GUI:setAnchorPoint(Panel_pos89, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_pos89, true)
	GUI:setTag(Panel_pos89, 69)
	TAGOBJ["69"] = Panel_pos89
	...
	-- Create DefaultIcon
	DefaultIcon = GUI:Image_Create(Panel_pos89, "DefaultIcon", 25, 25, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/1900015036.png")
	GUI:setContentSize(DefaultIcon, 47, 43)
	GUI:setIgnoreContentAdaptWithSize(DefaultIcon, false)
	GUI:setAnchorPoint(DefaultIcon, 0.50, 0.50)
	GUI:setTouchEnabled(DefaultIcon, false)
	...
	-- Create EquipShow_89
	local EquipShow_89 = GUI:EquipShow_Create(Panel_pos89, "EquipShow_89", 25, 25, 89, false, {bgVisible = false, doubleTakeOff = false, look = true, movable = false, starLv = true, lookPlayer = true, showModelEffect = false})
	...
	-- Create EquipShow_1
	local EquipShow_1 = GUI:EquipShow_Create(EquipUI, "EquipShow_1", 246, 95, 106, false, {bgVisible = true, doubleTakeOff = false, look = true, movable = false, starLv = false, lookPlayer = true, showModelEffect = false})
	GUI:setAnchorPoint(EquipShow_1, 0.50, 0.50)
	GUI:setScale(EquipShow_1, 0.80)
