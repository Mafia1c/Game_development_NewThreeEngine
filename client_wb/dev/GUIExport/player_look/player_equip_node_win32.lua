...
function ui.init(parent, __data__, __update__)
	...
	-- Create BG
	local BG = GUI:Image_Create(EquipUI, "BG", 136, 174, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015001.png")
	...
	local Node_playerModel = GUI:Node_Create(EquipUI, "Node_playerModel", 140, 138)
	GUI:setChineseName(Node_playerModel, "玩家装备_裸模")
	GUI:setTag(Node_playerModel, 139)
	TAGOBJ["139"] = Node_playerModel

	-- Create Panel_posEx0
	local Panel_posEx0 = GUI:Layout_Create(EquipUI, "Panel_posEx0", 136, 120, 80, 144, false)
	...
	-- Create Panel_posEx1
	local Panel_posEx1 = GUI:Layout_Create(EquipUI, "Panel_posEx1", 80, 190, 60, 120, false)
	...
	-- Create Panel_pos16
	local Panel_pos16 = GUI:Layout_Create(EquipUI, "Panel_pos16", 183, 132, 43, 71, false)
	...
	-- Create Panel_pos4
	local Panel_pos4 = GUI:Layout_Create(EquipUI, "Panel_pos4", 248, 282, 42, 42, false)
	...
	-- Create DefaultIcon
	local DefaultIcon = GUI:Image_Create(Panel_pos4, "DefaultIcon", 21, 21, "Default/ImageFile.png")
	...
	-- Create Panel_pos13
	local Panel_pos13 = GUI:Layout_Create(EquipUI, "Panel_pos13", 24, 231, 42, 42, false)
	...
	-- Create Panel_pos6
	local Panel_pos6 = GUI:Layout_Create(EquipUI, "Panel_pos6", 24, 127, 42, 42, false)
	...
	-- Create Panel_pos8
	local Panel_pos8 = GUI:Layout_Create(EquipUI, "Panel_pos8", 24, 76, 42, 42, false)
	...
	-- Create Panel_pos7
	local Panel_pos7 = GUI:Layout_Create(EquipUI, "Panel_pos7", 248, 76, 42, 42, false)
	...
	-- Create Panel_pos5
	local Panel_pos5 = GUI:Layout_Create(EquipUI, "Panel_pos5", 248, 127, 42, 42, false)
	...
	-- Create Panel_pos2
	local Panel_pos2 = GUI:Layout_Create(EquipUI, "Panel_pos2", 248, 179, 42, 42, false)
	...
	-- Create Panel_pos3
	local Panel_pos3 = GUI:Layout_Create(EquipUI, "Panel_pos3", 248, 230, 42, 42, false)
	...
	-- Create Panel_pos14
	local Panel_pos14 = GUI:Layout_Create(EquipUI, "Panel_pos14", 24, 24, 42, 42, false)
	...
	-- Create Panel_pos15
	local Panel_pos15 = GUI:Layout_Create(EquipUI, "Panel_pos15", 248, 24, 42, 42, false)
	...
	-- Create Panel_pos12
	local Panel_pos12 = GUI:Layout_Create(EquipUI, "Panel_pos12", 190, 24, 42, 42, false)
	...
	-- Create Panel_pos11
	local Panel_pos11 = GUI:Layout_Create(EquipUI, "Panel_pos11", 135, 24, 42, 42, false)
	...
	-- Create Panel_pos10
	local Panel_pos10 = GUI:Layout_Create(EquipUI, "Panel_pos10", 80, 24, 42, 42, false)
	...
	-- Create Panel_pos9
	local Panel_pos9 = GUI:Layout_Create(EquipUI, "Panel_pos9", 24, 178, 42, 42, false)
	...
	-- Create Node_6
	local Node_6 = GUI:Node_Create(EquipUI, "Node_6", 24, 127)
	GUI:setChineseName(Node_6, "玩家装备_左手镯_位置")
	GUI:setTag(Node_6, 147)
	TAGOBJ["147"] = Node_6

	-- Create Node_8
	local Node_8 = GUI:Node_Create(EquipUI, "Node_8", 24, 76)
	GUI:setChineseName(Node_8, "玩家装备_左戒指_位置")
	GUI:setTag(Node_8, 151)
	TAGOBJ["151"] = Node_8

	-- Create Node_7
	local Node_7 = GUI:Node_Create(EquipUI, "Node_7", 248, 76)
	GUI:setChineseName(Node_7, "玩家装备_右戒指_位置")
	GUI:setTag(Node_7, 155)
	TAGOBJ["155"] = Node_7

	-- Create Node_5
	local Node_5 = GUI:Node_Create(EquipUI, "Node_5", 248, 127)
	GUI:setChineseName(Node_5, "玩家装备_右手镯_位置")
	GUI:setTag(Node_5, 159)
	TAGOBJ["159"] = Node_5

	-- Create Node_2
	local Node_2 = GUI:Node_Create(EquipUI, "Node_2", 248, 179)
	GUI:setChineseName(Node_2, "玩家装备_勋章_位置")
	GUI:setTag(Node_2, 163)
	TAGOBJ["163"] = Node_2

	-- Create Node_3
	local Node_3 = GUI:Node_Create(EquipUI, "Node_3", 248, 230)
	GUI:setChineseName(Node_3, "玩家装备_项链_位置")
	GUI:setTag(Node_3, 167)
	TAGOBJ["167"] = Node_3

	-- Create Node_4
	local Node_4 = GUI:Node_Create(EquipUI, "Node_4", 248, 282)
	GUI:setChineseName(Node_4, "玩家装备_头盔_位置")
	GUI:setTag(Node_4, 210)
	TAGOBJ["210"] = Node_4

	-- Create Node_13
	local Node_13 = GUI:Node_Create(EquipUI, "Node_13", 24, 231)
	...
	-- Create Node_14
	local Node_14 = GUI:Node_Create(EquipUI, "Node_14", 24, 24)
	GUI:setChineseName(Node_14, "玩家装备_战鼓_位置")
	GUI:setTag(Node_14, 204)
	TAGOBJ["204"] = Node_14

	-- Create Node_15
	local Node_15 = GUI:Node_Create(EquipUI, "Node_15", 248, 24)
	GUI:setChineseName(Node_15, "玩家装备_坐骑_位置")
	GUI:setTag(Node_15, 208)
	TAGOBJ["208"] = Node_15

	-- Create Node_12
	local Node_12 = GUI:Node_Create(EquipUI, "Node_12", 190, 24)
	GUI:setChineseName(Node_12, "玩家装备_魔血石_位置")
	GUI:setTag(Node_12, 171)
	TAGOBJ["171"] = Node_12

	-- Create Node_11
	local Node_11 = GUI:Node_Create(EquipUI, "Node_11", 135, 24)
	GUI:setChineseName(Node_11, "玩家装备_靴子_位置")
	GUI:setTag(Node_11, 175)
	TAGOBJ["175"] = Node_11

	-- Create Node_10
	local Node_10 = GUI:Node_Create(EquipUI, "Node_10", 80, 24)
	GUI:setChineseName(Node_10, "玩家装备_腰带_位置")
	GUI:setTag(Node_10, 179)
	TAGOBJ["179"] = Node_10

	-- Create Node_9
	local Node_9 = GUI:Node_Create(EquipUI, "Node_9", 24, 178)
	GUI:setChineseName(Node_9, "玩家装备_护身符_位置")
	GUI:setTag(Node_9, 183)
	TAGOBJ["183"] = Node_9

	-- Create Text_guildinfo
	local Text_guildinfo = GUI:Text_Create(EquipUI, "Text_guildinfo", 9, 335, 18, "#ffffff", [[]])
	...
	-- Create Best_ringBox
	local Best_ringBox = GUI:Layout_Create(EquipUI, "Best_ringBox", 224, 302, 46, 36, false)
	...
	-- Create zfBtn
	local zfBtn = GUI:Button_Create(EquipUI, "zfBtn", 220, 338, "res/custom/mbtn/zf1.png")
	...
	-- Create Panel_pos89
	local Panel_pos89 = GUI:Layout_Create(EquipUI, "Panel_pos89", 24, 284, 42, 42, false)
	...
	-- Create EquipShow_89
	local EquipShow_89 = GUI:EquipShow_Create(Panel_pos89, "EquipShow_89", 22, 22, 89, false, {bgVisible = false, doubleTakeOff = false, look = true, movable = false, starLv = true, lookPlayer = true, showModelEffect = false})
