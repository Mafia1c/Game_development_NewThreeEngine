...
function ui.init(parent)
	...
	-- Create AttachLayout
	local AttachLayout = GUI:Layout_Create(FrameLayout, "AttachLayout", 30.00, 36.00, 732.00, 445.00, false)
	GUI:setChineseName(AttachLayout, "行会_内容布局")
	GUI:setTouchEnabled(AttachLayout, false)
	GUI:setTag(AttachLayout, -1)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 738.00, 490.00, "res/public/01.png")
	...
	-- Create page_cell_1
	local page_cell_1 = GUI:Button_Create(FrameLayout, "page_cell_1", 775.00, 398.00, "res/public/1900000641.png")
...
会]])
	...
	-- Create page_cell_2
	local page_cell_2 = GUI:Button_Create(FrameLayout, "page_cell_2", 774.00, 312.00, "res/public/1900000641.png")
...
员]])
	...
	-- Create page_cell_3
	local page_cell_3 = GUI:Button_Create(FrameLayout, "page_cell_3", 775.00, 227.00, "res/public/1900000641.png")
