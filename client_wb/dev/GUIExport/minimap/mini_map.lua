...
function ui.init(parent, __data__, __update__)
	...
	-- Create CloseLayout
	local CloseLayout = GUI:Layout_Create(Node, "CloseLayout", 0, 0, 1136, 640, false)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Node, "Panel_1", 568, 340, 760, 520, false)
	...
	-- Create FrameLayout
	local FrameLayout = GUI:Layout_Create(Panel_1, "FrameLayout", 380, 260, 760, 520, false)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/private/minimap/minibg.png")
	GUI:setContentSize(FrameBG, 760, 520)
	...
	-- Create DressIMG
	local DressIMG = GUI:Image_Create(FrameLayout, "DressIMG", -14, 564, "res/public/1900000610_1.png")
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 79, 483, 20, "#d8c8ae", [[地图]])
	...
	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 726, 483, "res/public/01.png")
	...
	-- Create Panel_map
	local Panel_map = GUI:Layout_Create(Panel_1, "Panel_map", 282, 262, 536, 426, true)
	GUI:setChineseName(Panel_map, "大地图 _内组合")
	GUI:setAnchorPoint(Panel_map, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_map, true)
	GUI:setTag(Panel_map, 21)
	TAGOBJ["21"] = Panel_map

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_map, "Image_bg", 268, 213, "res/private/minimap/1900012103.png")
	...
	local Panel_minimap = GUI:Layout_Create(Panel_map, "Panel_minimap", 268, 213, 536, 426, false)
	...
	local Image_mini_map = GUI:Image_Create(Panel_minimap, "Image_mini_map", 268, 213, "Default/ImageFile.png")
	...
	-- Create Panel_event
	local Panel_event = GUI:Layout_Create(Panel_minimap, "Panel_event", 268, 213, 200, 200, false)
	...
	-- Create Image_point
	local Image_point = GUI:Layout_Create(Panel_minimap, "Image_point", 100, 80, 100, 24, false)
	...
	-- Create Text_point
	local Text_point = GUI:Text_Create(Image_point, "Text_point", 50, 12, 15, "#00ff00", [[(123，123）]])
	...
	local Image_mapNameBG = GUI:Image_Create(Panel_1, "Image_mapNameBG", 395, 590, "res/private/minimap/1900012107.png")
	...
	-- Create Text_mapName
	local Text_mapName = GUI:Text_Create(Panel_1, "Text_mapName", 71, 486, 16, "#ffffff", [[地图]])
	GUI:Text_enableOutline(Text_mapName, "#000000", 1)
	GUI:setChineseName(Text_mapName, "大地图 _地图名称_文本")
	GUI:setAnchorPoint(Text_mapName, 0.00, 0.00)
	GUI:setTouchEnabled(Text_mapName, false)
	GUI:setTag(Text_mapName, -1)

	-- Create ImageView
	local ImageView = GUI:Image_Create(Panel_1, "ImageView", 282, 262, "res/private/minimap/1900012104.png")
	GUI:setContentSize(ImageView, 540, 430)
