...
function ui.init(parent)
	...
	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 740.00, 493.00, "res/public/01.png")
	...
	-- Create page_cell_1
	local page_cell_1 = GUI:Button_Create(FrameLayout, "page_cell_1", 775.00, 380.00, "res/public/1900000641.png")
...
近]])
	...
	-- Create page_cell_2
	local page_cell_2 = GUI:Button_Create(FrameLayout, "page_cell_2", 775.00, 305.00, "res/public/1900000641.png")
...
队]])
	...
	-- Create page_cell_3
	local page_cell_3 = GUI:Button_Create(FrameLayout, "page_cell_3", 775.00, 230.00, "res/public/1900000641.png")
...
友]])
	...
	-- Create page_cell_4
	local page_cell_4 = GUI:Button_Create(FrameLayout, "page_cell_4", 775.00, 155.00, "res/public/1900000641.png")
...
件]])
	...
	-- Create page_cell_5
	local page_cell_5 = GUI:Button_Create(FrameLayout, "page_cell_5", 775.00, 80.00, "res/public/1900000641.png")
	...
	GUI:Button_titleEnableOutline(page_cell_5, "#000000", 1)
	GUI:setChineseName(page_cell_5, "社交_关系_组合")
	GUI:setTouchEnabled(page_cell_5, false)
	GUI:setTag(page_cell_5, -1)

	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_5, "PageText", 13.00, 56.00, 16, "#807256", [[关
系]])
	GUI:setChineseName(PageText, "社交_关系_文本")
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1)
	GUI:Text_enableOutline(PageText, "#111111", 2)
	...
	GUI:setChineseName(TouchSize, "社交_关系_触摸")
	GUI:setAnchorPoint(TouchSize, 0.00, 1.00)
	GUI:setTouchEnabled(TouchSize, true)
	GUI:setTag(TouchSize, -1)
end
