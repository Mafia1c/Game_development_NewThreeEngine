...
function ui.init(parent, __data__, __update__)
	...
	-- Create titleTxt
	local titleTxt = GUI:Text_Create(FrameLayout, "titleTxt", 225, 166, 18, "#ff9b00", [[兑换提示]])
	...
	-- Create center_txt_1
	local center_txt_1 = GUI:Text_Create(FrameLayout, "center_txt_1", 225, 111, 18, "#ffffff", [[开通盟重令 可以一键兑换实物且兑换不限次数!]])
	...
	GUI:Button_setTitleColor(noBtn, "#ffffff")
