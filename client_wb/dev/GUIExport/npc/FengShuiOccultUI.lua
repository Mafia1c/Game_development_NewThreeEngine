...
function ui.init(parent, __data__, __update__)
	...
	-- Create RichText_1
	local RichText_1 = GUI:RichText_Create(FrameLayout, "RichText_1", 213, 454, [[<font color='#00ff00' size='18' >点击 </font><font color='#ffff00' size='18' >图标 </font><font color='#00ff00' size='18' >查属性</font>]], 150, 18, "#00ff00", 4)
	...
	-- Create unlock_btn
	local unlock_btn = GUI:Button_Create(FrameLayout, "unlock_btn", 586, 72, "res/custom/npc/31mishu/lwms11.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(FrameLayout, "Text_1", 649, 51, 18, "#ffffff", [==========[提示：使用[          ]可解封秘术]==========])
