...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/30xiuwei/mian.png")
	...
	-- Create layerBg
	local layerBg = GUI:Image_Create(midNode, "layerBg", 92, 354, "res/custom/npc/30xiuwei/jingjie_di.png")
	GUI:setAnchorPoint(layerBg, 0.00, 0.00)
	GUI:setTouchEnabled(layerBg, false)
	GUI:setTag(layerBg, 0)

	-- Create layerImg
	local layerImg = GUI:Image_Create(layerBg, "layerImg", 0, 8, "res/custom/npc/30xiuwei/jingjie_0.png")
	GUI:setAnchorPoint(layerImg, 0.00, 0.00)
	GUI:setTouchEnabled(layerImg, false)
	GUI:setTag(layerImg, 0)

	-- Create RichText1
	local RichText1 = GUI:RichText_Create(midNode, "RichText1", 80, 44, [[<font color='#ff0000' size='18' >突破规则：</font><br><font color='#f0b42a' size='18' >收集所需的物品，即可提升当前</font><font color='#00ff00' size='18' >境界修为</font><br><font color='#f0b42a' size='18' >突破境界几率成功，当前突破几率</font><font color='#ff9b00' size='18' >：</font><font color='#00ff00' size='18' >100%</font>]], 360, 18, "#ff0000", 4)
	GUI:setAnchorPoint(RichText1, 0.00, 0.00)
	GUI:setTag(RichText1, 0)

	-- Create infoNode1
	local infoNode1 = GUI:Node_Create(midNode, "infoNode1", 686, 394)
	GUI:setTag(infoNode1, 0)

	-- Create text111
	local text111 = GUI:Text_Create(infoNode1, "text111", 0, 0, 16, "#ffffff", [[攻魔道：]])
	...
	-- Create text131
	local text131 = GUI:Text_Create(infoNode1, "text131", 0, 0, 16, "#ffffff", [[生命加成：]])
	...
	-- Create text132
	local text132 = GUI:Text_Create(text131, "text132", 80, 0, 16, "#00ff00", [[2%]])
	...
	-- Create infoNode2
	local infoNode2 = GUI:Node_Create(midNode, "infoNode2", 686, 240)
	GUI:setTag(infoNode2, 0)

	-- Create text211
	local text211 = GUI:Text_Create(infoNode2, "text211", 0, 0, 16, "#ffffff", [[攻魔道：]])
	...
	-- Create text231
	local text231 = GUI:Text_Create(infoNode2, "text231", 0, 0, 16, "#ffffff", [[生命加成：]])
	...
	-- Create text232
	local text232 = GUI:Text_Create(text231, "text232", 80, 0, 16, "#00ff00", [[2%]])
	...
	-- Create needItemNode
	local needItemNode = GUI:Node_Create(midNode, "needItemNode", 682, 118)
	GUI:setTag(needItemNode, 0)

	-- Create upBtn
	local upBtn = GUI:Button_Create(midNode, "upBtn", 686, 60, "res/custom/npc/anb1.png")
	GUI:Button_loadTexturePressed(upBtn, "res/custom/npc/anb2.png")
	GUI:Button_setScale9Slice(upBtn, 0, 0, 0, 0)
	GUI:setContentSize(upBtn, 112, 36)
	GUI:setIgnoreContentAdaptWithSize(upBtn, false)
	GUI:Button_setTitleText(upBtn, [[修炼]])
	...
	-- Create maxImg
	local maxImg = GUI:Image_Create(midNode, "maxImg", 682, 100, "res/custom/tag/c_103.png")
