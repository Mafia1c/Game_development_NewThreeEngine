...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/50zh/bg2.png")
	...
	-- Create needItem_2
	local needItem_2 = GUI:ItemShow_Create(FrameLayout, "needItem_2", 682, 139, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(needItem_2, 0.50, 0.50)
	GUI:setTag(needItem_2, 0)

	-- Create RichText_1
	local RichText_1 = GUI:RichText_Create(FrameLayout, "RichText_1", 89, 45, [==========[<font color='#ffff00' size='18' >[幻灵石] </font><font color='#bdbdb5' size='18' >封魔谷 </font><font color='#00ff00' size='18' >BOSS</font><font color='#bdbdb5' size='18' > 均可掉落!</font>]==========], 300, 16, "#ffffff", 4)
	...
	-- Create attrLayout
	local attrLayout = GUI:Layout_Create(FrameLayout, "attrLayout", 617, 232, 138, 193, false)
