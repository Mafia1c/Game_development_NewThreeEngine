...
function ui.init(parent, __data__, __update__)
	...
	-- Create save_active_btn
	local save_active_btn = GUI:Button_Create(FrameLayout, "save_active_btn", 684, 80, "res/custom/npc/an.png")
	GUI:Button_loadTexturePressed(save_active_btn, "res/custom/npc/an2.png")
	GUI:setContentSize(save_active_btn, 104, 38)
	GUI:setIgnoreContentAdaptWithSize(save_active_btn, false)
	GUI:Button_setTitleText(save_active_btn, [[保存激活]])
	GUI:Button_setTitleColor(save_active_btn, "#efd6ad")
	GUI:Button_setTitleFontSize(save_active_btn, 18)
	GUI:Button_titleEnableOutline(save_active_btn, "#000000", 1)
	GUI:setAnchorPoint(save_active_btn, 0.00, 0.00)
	GUI:setTouchEnabled(save_active_btn, true)
	GUI:setTag(save_active_btn, 0)

	-- Create reset_btn
	local reset_btn = GUI:Button_Create(FrameLayout, "reset_btn", 547, 80, "res/custom/npc/an.png")
	GUI:Button_loadTexturePressed(reset_btn, "res/custom/npc/an2.png")
	GUI:setContentSize(reset_btn, 104, 38)
	GUI:setIgnoreContentAdaptWithSize(reset_btn, false)
	GUI:Button_setTitleText(reset_btn, [[重置血脉]])
	GUI:Button_setTitleColor(reset_btn, "#efd6ad")
	...
	local cur_active_text = GUI:Text_Create(FrameLayout, "cur_active_text", 669, 59, 18, "#ff0000", [[当前激活：未激活]])
	...
	-- Create select_img
	local select_img = GUI:Image_Create(FrameLayout, "select_img", 271, 165, "res/custom/npc/35xm/2/xz.png")
	GUI:setAnchorPoint(select_img, 0.00, 0.00)
	GUI:setTouchEnabled(select_img, false)
	GUI:setTag(select_img, 0)

	-- Create xuemai_listview
	local xuemai_listview = GUI:ListView_Create(FrameLayout, "xuemai_listview", 538, 137, 262, 315, 1)
	GUI:ListView_setBounceEnabled(xuemai_listview, true)
	GUI:ListView_setGravity(xuemai_listview, 2)
	GUI:setAnchorPoint(xuemai_listview, 0.00, 0.00)
	GUI:setTouchEnabled(xuemai_listview, true)
	GUI:setTag(xuemai_listview, 0)
