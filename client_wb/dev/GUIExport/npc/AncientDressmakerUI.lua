...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/47jx/bg1.png")
	...
	-- Create ItemShow_1
	local ItemShow_1 = GUI:ItemShow_Create(ItemNode, "ItemShow_1", -128, 0, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(ItemShow_1, 0.50, 0.50)
	GUI:setTag(ItemShow_1, 0)

	-- Create ItemShow_2
	local ItemShow_2 = GUI:ItemShow_Create(ItemNode, "ItemShow_2", -43, 0, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(ItemShow_2, 0.50, 0.50)
	GUI:setTag(ItemShow_2, 0)

	-- Create ItemShow_3
	local ItemShow_3 = GUI:ItemShow_Create(ItemNode, "ItemShow_3", 42, 0, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(ItemShow_3, 0.50, 0.50)
	GUI:setTag(ItemShow_3, 0)

	-- Create ItemShow_4
	local ItemShow_4 = GUI:ItemShow_Create(ItemNode, "ItemShow_4", 127, 0, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	...
	GUI:setVisible(ItemShow_5, false)
	...
	-- Create forge_btn
	local forge_btn = GUI:Button_Create(FrameLayout, "forge_btn", 521, 57, "res/custom/npc/an.png")
	...
	GUI:Button_setTitleColor(forge_btn, "#ffffff")
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(pageList_1, "Button_1", 0, 406, "res/custom/npc/ta0.png")
	GUI:Button_loadTexturePressed(Button_1, "res/custom/npc/ta1.png")
	GUI:setContentSize(Button_1, 120, 44)
	GUI:setIgnoreContentAdaptWithSize(Button_1, false)
	GUI:Button_setTitleText(Button_1, [[传承·Ⅱ]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(FrameLayout, "Text_3", 626, 128, 18, "#00ff00", [[100%]])
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(Text_3, "Text_2", -106, 0, 18, "#c6c6ce", [[锻造成功率：]])
