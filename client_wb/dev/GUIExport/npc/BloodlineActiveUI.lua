...
function ui.init(parent, __data__, __update__)
	...
	-- Create kapai_1
	local kapai_1 = GUI:Image_Create(FrameLayout, "kapai_1", 47, 146, "res/custom/npc/12tmfw/2/k111.png")
	...
	-- Create kapai_2
	local kapai_2 = GUI:Image_Create(FrameLayout, "kapai_2", 264, 146, "res/custom/npc/12tmfw/2/k444.png")
	...
	-- Create kapai_3
	local kapai_3 = GUI:Image_Create(FrameLayout, "kapai_3", 482, 146, "res/custom/npc/12tmfw/2/k444.png")
	...
	-- Create Image_4
	local Image_4 = GUI:Image_Create(FrameLayout, "Image_4", 239, 447, "res/custom/npc/12tmfw/2/z1.png")
	GUI:setAnchorPoint(Image_4, 0.00, 0.00)
	GUI:setTouchEnabled(Image_4, false)
	GUI:setTag(Image_4, 0)

	-- Create reflush_btn
	local reflush_btn = GUI:Button_Create(FrameLayout, "reflush_btn", 537, 52, "res/custom/npc/an.png")
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(FrameLayout, "Text_2", 212, 72, 18, "#deded6", [[使用：天命石*1，可刷新当前天命符文]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(FrameLayout, "Text_3", 259, 44, 18, "#00ff00", [[每刷新10次必出传说天命！]])
