...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 104.00, 493.00, 20, "#d8c8ae", [[]])
	...
	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 740.00, 492.00, "res/public/01.png")
