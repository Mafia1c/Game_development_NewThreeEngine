...
function ui.init(parent, __data__, __update__)
	...
	-- Create Panel_input
	local Panel_input = GUI:Layout_Create(Node, "Panel_input", 0, 0, 732, 445, false)
	...
	TAGOBJ["16"] = Panel_input

	-- Create Image_bg1
	local Image_bg1 = GUI:Image_Create(Panel_input, "Image_bg1", 366, 425, "res/public/1900000668.png")
	...
	-- Create Image_bg2
	local Image_bg2 = GUI:Image_Create(Panel_input, "Image_bg2", 366, 405, "res/public/1900000668.png")
	...
	-- Create Image_bg3
	local Image_bg3 = GUI:Image_Create(Panel_input, "Image_bg3", 366, 205, "res/public/1900000668.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_input, "Text_1", 10, 425, 18, "#f8e6c6", [[本服名称:]])
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(Panel_input, "Text_2", 300, 425, 18, "#f8e6c6", [[充值角色:]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_input, "Text_3", 10, 370, 18, "#f8e6c6", [[货币种类:]])
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_input, "Text_4", 10, 310, 18, "#f8e6c6", [[充值金额:]])
	...
	-- Create Text_5
	local Text_5 = GUI:Text_Create(Panel_input, "Text_5", 10, 260, 18, "#f8e6c6", [[充值方式:]])
	...
	local Text_servername = GUI:Text_Create(Panel_input, "Text_servername", 95, 425, 18, "#f8e6c6", [[本服名称]])
	...
	TAGOBJ["18"] = Text_servername

	-- Create Text_rolename
	local Text_rolename = GUI:Text_Create(Panel_input, "Text_rolename", 385, 425, 18, "#f8e6c6", [[充值角色]])
	...
	TAGOBJ["19"] = Text_rolename

	-- Create ListView_cells
	local ListView_cells = GUI:ListView_Create(Panel_input, "ListView_cells", 100, 370, 600, 50, 2)
	...
	TAGOBJ["51"] = ListView_cells

	-- Create Image_input_bg
	local Image_input_bg = GUI:Image_Create(Panel_input, "Image_input_bg", 95, 310, "res/private/powerful_secret/input_bg.png")
	...
	TAGOBJ["56"] = Image_input_bg

	-- Create TextField_input
	local TextField_input = GUI:TextInput_Create(Panel_input, "TextField_input", 97, 310, 105, 24, 18)
	...
	TAGOBJ["22"] = TextField_input

	-- Create Text_6
	local Text_6 = GUI:Text_Create(Panel_input, "Text_6", 17, 293, 14, "#ffff00", [[输入金额]])
	...
	local Text_exchange = GUI:Text_Create(Panel_input, "Text_exchange", 210, 310, 18, "#f8e6c6", [[ss]])
	...
	TAGOBJ["32"] = Text_exchange

	-- Create Button_alipay
	local Button_alipay = GUI:Button_Create(Panel_input, "Button_alipay", 140, 260, "res/private/powerful_secret/bg_czzya_05.png")
	...
	TAGOBJ["58"] = Image_flag

	-- Create Button_huabei
	local Button_huabei = GUI:Button_Create(Panel_input, "Button_huabei", 250, 260, "res/private/powerful_secret/bg_czzya_06.png")
	...
	TAGOBJ["57"] = Image_flag

	-- Create Button_weixin
	local Button_weixin = GUI:Button_Create(Panel_input, "Button_weixin", 360, 260, "res/private/powerful_secret/bg_czzya_04.png")
	...
	TAGOBJ["59"] = Image_flag

	-- Create Button_submit
	local Button_submit = GUI:Button_Create(Panel_input, "Button_submit", 640, 260, "res/public/1900000660.png")
	...
	TAGOBJ["21"] = Button_submit

	-- Create Node_desc
	local Node_desc = GUI:Node_Create(Panel_input, "Node_desc", 10, 195)
	GUI:setChineseName(Node_desc, "充值_充值说明_节点")
	GUI:setTag(Node_desc, 50)
	TAGOBJ["50"] = Node_desc

	-- Create Text_more
	local Text_more = GUI:Text_Create(Panel_input, "Text_more", 320, 260, 18, "#f8e6c6", [[更多支付方式]])
	...
	-- Create moreText
	local moreText = GUI:Text_Create(Panel_input, "moreText", 14, 18, 16, "#ffffff", [[单笔充值满10元，额外赠送100%]])
